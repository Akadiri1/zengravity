<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <input id="name" class="w-full h-11 px-4 rounded-xl bg-white/[0.03] border border-white/10 text-white placeholder-gray-600 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition" 
        ...
        <div class="relative py-2">
            ...
            <div class="relative flex justify-center text-xs uppercase">
                <span class="bg-[#0a0a0a] px-2 text-gray-500 font-bold tracking-wider">Or sign up with</span>
            </div>
        </div>
